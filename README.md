...
Thanks to [@pdezwart](/pdezwart) for the method stubs, and [the contributors](/videlalvaro/php-amqplib/graphs/contributors) to php-amqplib, which is largely what this library is based on.
